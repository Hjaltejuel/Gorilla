...
namespace UITEST.View
{
    public sealed partial class CommentControl : UserControl
    {
        ...
        private readonly CommentControlViewModel _vm;
        public CommentControl(Comment comment)
        {
            ...
            _vm = App.ServiceProvider.GetService<CommentControlViewModel>();
            _vm.Initialize(comment);
            DataContext = _vm;
        ...
        //private void LikeSuccesful(int direction)
        //{
        //    int votes;
        ...
        //        PointsTextBlock.Text = (votes - 1*direction).ToString();
        //    }else{
        //        if (Downvote.Style.Equals(DownvoteClickedStyle))
        //        {
        //            PointsTextBlock.Text = (votes + 2*direction).ToString();
